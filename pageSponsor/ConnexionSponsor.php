    ...
    <header class="header">
        ...
        <form action="" method="post">
            ...
            <div class="inscription">
                <p><a href="InscriptionSponsor.php">Pas encore de compte ? S'inscrire</a></p>
            </div>
        </form>
</body>
</html>
...
<?php
    ...
    if (isset($_POST['Username']) && isset($_POST['Password'])) {
        ...
        try {
            $stmt1 = $conn->prepare("SELECT u.nom_utilisateur, mot_de_passe FROM sponsors s, utilisateurs u WHERE u.nom_utilisateur= :nom_utilisateur AND u.nom_utilisateur=s.nom_utilisateur AND mot_de_passe=:mot_de_passe");
