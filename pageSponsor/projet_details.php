...
<body style="background: #1362e9 !important; overflow: hidden;">
    ...
    <div class="container showprojet">
        <div class="cards-container" >
             <a href="<?php echo '../PageFreelance/'.$img;?>"><div class="card col-md-6"><?php if($img==''){echo'Aucune image';}else{echo 'Cliquer ici pour voir';}?></div></a>
             <a href="<?php echo '../PageFreelance/'. $exe;?>"><div class="card col-md-6"><?php if($exe==''){echo'Aucun fichier executable';}else{echo 'Cliquer ici pour voir';}?></div></a>
        </div>
        <div class="cards-container">              
            <a href="<?php echo '../PageFreelance/'.$rm;?>"><div class="card col-md-6"><?php if($rm==''){echo'Aucun fichier readme';}else{echo 'Cliquer ici pour voir';}?></div></a>
            <a href="<?php echo '../PageFreelance/'.$code;?>"><div class="card col-md-6"><?php if($code==''){echo'Aucun code source';}else{echo 'Cliquer ici pour voir';}?></div></a>
